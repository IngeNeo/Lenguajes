package Lenguajes.Java.EjemploBaseDatosSelect;
...
public class EjemploBaseDatosSelect {
	...
	public static void main(String[] args) {
		try {
			...
			/*
			 * Se obtiene una conexión a la base de datos usando el DriverManager Nos
			 * conectaremos a un servidor SQL en nuestra máquina (localhost) y a una base de
			 * datos existente llamada concesionario
			 */
			String url = "jdbc:mysql://localhost/concesionario";
			Connection conexion = DriverManager.getConnection(url, "root", "");
			// Se crea una consulta, en este caso para obtener todos los registros de la
			// tabla vendedores
