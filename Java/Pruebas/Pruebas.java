...
public class Pruebas {
	...
	public static void main(String[] args) {
		...
		/*
		 * Scanner entrada = new Scanner(System.in);
		 * System.out.print("Digite el nombre del libro: "); String nombre =
		 * entrada.nextLine();
		 *
		 * System.out.print("Digite el ID del libro: "); int id = entrada.nextInt();
		 *
		 * System.out.print("Digite el precio del libro: "); double precio =
		 * entrada.nextDouble();
		 *
		 * System.out.print("El envio es gratuito (true, false): "); boolean
		 * envioGratuito = entrada.nextBoolean();
		 *
		 * System.out.println(nombre + " #" + id); System.out.println("Precio: " + "$" +
		 * precio); System.out.println("Envio Gratuito: " + envioGratuito);
		 */

		/*
		 * Scanner scanner = new Scanner(System.in); // Escribe tu solucion aqui
		 * System.out.print("Digite el alto: "); int alto =
		 * Integer.parseInt(scanner.nextLine()); System.out.print("Digite el ancho: ");
		 * int ancho = Integer.parseInt(scanner.nextLine()); int area = alto * ancho;
		 * int perimetro = (alto + ancho) * 2; System.out.println("Area: " + area);
		 * System.out.println("Perimetro: " + perimetro);
		 */

		/*
		 * Scanner scanner = new Scanner(System.in);
		 * System.out.print("Digite el numero 1: "); int numero1 =
		 * Integer.parseInt(scanner.nextLine());
		 * System.out.print("Digite el numero 2: "); int numero2 =
		 * Integer.parseInt(scanner.nextLine());
		 * System.out.print("El numero mayor es: "); System.out.println(numero1 >
		...
		double localizacionX = 5, localizacionY = 10;
